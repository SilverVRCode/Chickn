...
<template>
  ...
  <aside id="separator-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
     <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
        <ul class="space-y-2 font-medium">
           <li>
              <a href="#" class="p-2 text-left text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group flex items-center">
                 ...
                 <span class="ms-3 text-left">Dashboard</span>
              </a>
           </li>
           <li>
              <a href="#" class="p-2 text-left text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group flex items-center">
                 ...
                 <span class="flex-1 ms-3 whitespace-nowrap text-left">Kanban</span>
           ...
           <li>
              <a href="#" class="p-2 text-left text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group flex items-center">
                 ...
                 <span class="flex-1 ms-3 whitespace-nowrap text-left">Inbox</span>
           ...
           <li>
              <a href="#" class="p-2 text-left text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group flex items-center">
                 ...
                 <span class="flex-1 ms-3 whitespace-nowrap text-left">Users</span>
              </a>
           </li>
           <li>
              <a href="#" class="p-2 text-left text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group flex items-center">
                 ...
                 <span class="flex-1 ms-3 whitespace-nowrap text-left">Products</span>
              </a>
           </li>
           <li>
              <a href="#" class="p-2 text-left text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group flex items-center">
        ...
        <ul class="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200 dark:border-gray-700">
           <li>
              <a href="#" class="p-2 text-left text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group flex items-center">
                 ...
                 <span class="ms-3 text-left">Upgrade to Pro</span>
              </a>
           </li>
           <li>
              <a href="#" class="p-2 text-left text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group flex items-center">
                 ...
                 <span class="ms-3 text-left">Documentation</span>
              </a>
           </li>
           <li>
              <a href="#" class="p-2 text-left text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group flex items-center">
                 ...
                 <span class="ms-3 text-left">Components</span>
              </a>
           </li>
           <li>
              <a href="#" class="p-2 text-left text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group flex items-center">
                 ...
                 <span class="ms-3 text-left">Help</span>
              </a>
           </li>
        </ul>
     </div>
  ...
  <div class="p-4 sm:ml-64">
     <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
        <!-- Main content area, boxes removed -->
     </div>
  </div>
</template>